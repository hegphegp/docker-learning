...
docker run -itd --privileged --net=host --restart always --name openvpn -e USERNAME=heguopei -e PASSWORD="Heguopei\$123" -e CONFIG_FILE_NAME=client.ovpn -v /opt/soft/openvpn-client:/openvpn openvpn:2.4.6-r3
