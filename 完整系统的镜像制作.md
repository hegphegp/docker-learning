...
```
# apt-get安装lsb-core，居然用了两百多MB空间，这是无法忍受的，不再安装lsb-core，使用制作的脚本兼容 lsb_release -cs 指令
...
COPY lsb_release /opt/soft/bin/lsb_release

RUN chmod +x /opt/soft/bin/lsb_release; \
...
# apt-get安装lsb-core，居然用了两百多MB空间，这是无法忍受的，不再安装lsb-core
