...
rm -rf CentOS-7-x86_64-Vagrant-1907_01
mkdir -p CentOS-7-x86_64-Vagrant-1907_01
cd CentOS-7-x86_64-Vagrant-1907_01
...
# 步骤05 清空网络配置，然后作为模板
# 网上说，要删除 /etc/udev/rules.d/70-persistent-net.rules ，用官方的CentOS-7-x86_64-Vagrant-1907_01.VirtualBox.box创建虚拟机，/etc/udev/rules.d目录下面没有任何文件
